...
namespace Dissonance.Integrations.UNet_HLAPI
{
    ...
    public class HlapiPlayer : NetworkBehaviour, IDissonancePlayer
    {
        ...
        public override void OnStartAuthority()
        {
            ...
            if (comms == null)
                throw Log.UserError("cannot find DissonanceComms component in scene", "not placing a DissonanceComms component on a game object in the scene", "https://dissonance.readthedocs.io/en/latest/Basics/Getting%20Started/", "9A79FDCB-263E-4124-B54D-67EDA39C09A5");
        ...
        {
            if (_isTracking)
                throw Log.PossibleBug("Attempting to start player tracking, but tracking is already started", "B7D1F25E-72AF-4E93-8CFF-90CEBEAC68CF");
        ...
        {
            if (!_isTracking)
                throw Log.PossibleBug("Attempting to stop player tracking, but tracking is not started", "EC5C395D-B544-49DC-B33C-7D7533349134");
