...
//Martin (2016):
// Original version from: http://www.lomont.org/Software/Misc/FFT/LomontFFT.cs
// This version has been modified to use floats instead of doubles. This probably compromises
// the accuracy somewhat but I don't care because I'm only using this for VAD
...
namespace Dissonance.VAD
{
    ...
    internal class LomontFFT
    {
        ...
        private void TableFFT(float[] data, bool forward)
        {
            var n = data.Length;
        ...
        private void Scale(float[] data, int n, bool forward)
        {
        ...
        private void Initialize(int size)
        {
            ...
            _cosTable = new float[size];
            _sinTable = new float[size];
        ...
        /// <param name="data"></param>                                                                          
        /// <param name="n"></param>                                                                             
        private static void Reverse(float[] data, int n)
        {
