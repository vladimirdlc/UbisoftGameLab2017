...
namespace Dissonance.Audio.Playback
{
    ...
    internal class VolumeRampedFrameSource : IFrameSource
    {
        ...
        private readonly Func<float> _targetVolumeFunc;

        private float _targetVolume;
        private float _currentVolume;

        public VolumeRampedFrameSource(IFrameSource source, Func<float> targetVolume = null)
        {
            _source = source;
            _targetVolumeFunc = targetVolume;
        }
        ...
        public bool Read(ArraySegment<float> frame)
        {
            ...
            _targetVolume = complete ? 0 : _targetVolumeFunc();
